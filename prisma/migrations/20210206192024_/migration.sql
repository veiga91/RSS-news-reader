...
-- CreateTable
CREATE TABLE "_FeedToSavedArticle" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_FeedToSavedArticle_AB_unique" ON "_FeedToSavedArticle"("A", "B");

-- CreateIndex
CREATE INDEX "_FeedToSavedArticle_B_index" ON "_FeedToSavedArticle"("B");
...
-- AddForeignKey
ALTER TABLE "_FeedToSavedArticle" ADD FOREIGN KEY ("A") REFERENCES "Feed"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_FeedToSavedArticle" ADD FOREIGN KEY ("B") REFERENCES "SavedArticle"("id") ON DELETE CASCADE ON UPDATE CASCADE;
